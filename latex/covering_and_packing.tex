...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {../programming/c++/zeta_transform/src/fztlin_time1};
\addplot table[x=df,y=systime] {../programming/c++/zeta_transform/src/fztlin_time1};
\end{axis}
\end{tikzpicture}
...
\addplot table[x=df,y=vm] {../programming/c++/zeta_transform/src/fztlin_mem1};
\addplot table[x=df,y=rss] {../programming/c++/zeta_transform/src/fztlin_mem1};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=time (ms)]
\addplot table[x=n,y=time] {../programming/c++/zeta_transform/src/fztlin_time2};
\addplot table[x=n,y=systime] {../programming/c++/zeta_transform/src/fztlin_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {../programming/c++/zeta_transform/src/fztlin_mem2};
\addplot table[x=n,y=rss] {../programming/c++/zeta_transform/src/fztlin_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {../programming/c++/zeta_transform/src/k_cover_time1};
\addplot table[x=df,y=systime] {../programming/c++/zeta_transform/src/k_cover_time1};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=df,y=vm] {../programming/c++/zeta_transform/src/k_cover_mem1};
\addplot table[x=df,y=rss] {../programming/c++/zeta_transform/src/k_cover_mem1};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=time (ms)]
\addplot table[x=n,y=time] {../programming/c++/zeta_transform/src/k_cover_time2};
\addplot table[x=n,y=systime] {../programming/c++/zeta_transform/src/k_cover_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {../programming/c++/zeta_transform/src/k_cover_mem2};
\addplot table[x=n,y=rss] {../programming/c++/zeta_transform/src/k_cover_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=time (ms)]
\addplot table[x=k,y=time] {../programming/c++/zeta_transform/src/k_cover_time3};
\addplot table[x=k,y=systime] {../programming/c++/zeta_transform/src/k_cover_time3};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=k,y=vm] {../programming/c++/zeta_transform/src/k_cover_mem3};
\addplot table[x=k,y=rss] {../programming/c++/zeta_transform/src/k_cover_mem3};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {../programming/c++/zeta_transform/src/k_partition_time1};
\addplot table[x=df,y=systime] {../programming/c++/zeta_transform/src/k_partition_time1};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=df,y=vm] {../programming/c++/zeta_transform/src/k_partition_mem1};
\addplot table[x=df,y=rss] {../programming/c++/zeta_transform/src/k_partition_mem1};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=time (ms)]
\addplot table[x=n,y=time] {../programming/c++/zeta_transform/src/k_partition_time2};
\addplot table[x=n,y=systime] {../programming/c++/zeta_transform/src/k_partition_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {../programming/c++/zeta_transform/src/k_partition_mem2};
\addplot table[x=n,y=rss] {../programming/c++/zeta_transform/src/k_partition_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=time (ms)]
\addplot table[x=k,y=time] {../programming/c++/zeta_transform/src/k_partition_time3};
\addplot table[x=k,y=systime] {../programming/c++/zeta_transform/src/k_partition_time3};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=k,y=vm] {../programming/c++/zeta_transform/src/k_partition_mem3};
\addplot table[x=k,y=rss] {../programming/c++/zeta_transform/src/k_partition_mem3};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {../programming/c++/zeta_transform/src/k_packing_time1};
\addplot table[x=df,y=systime] {../programming/c++/zeta_transform/src/k_packing_time1};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=df,y=vm] {../programming/c++/zeta_transform/src/k_packing_mem1};
\addplot table[x=df,y=rss] {../programming/c++/zeta_transform/src/k_packing_mem1};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=time (ms)]
\addplot table[x=n,y=time] {../programming/c++/zeta_transform/src/k_packing_time2};
\addplot table[x=n,y=systime] {../programming/c++/zeta_transform/src/k_packing_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {../programming/c++/zeta_transform/src/k_packing_mem2};
\addplot table[x=n,y=rss] {../programming/c++/zeta_transform/src/k_packing_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=time (ms)]
\addplot table[x=k,y=time] {../programming/c++/zeta_transform/src/k_packing_time3};
\addplot table[x=k,y=systime] {../programming/c++/zeta_transform/src/k_packing_time3};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=k,y=vm] {../programming/c++/zeta_transform/src/k_packing_mem3};
\addplot table[x=k,y=rss] {../programming/c++/zeta_transform/src/k_packing_mem3};
\end{axis}
\end{tikzpicture}
